...
?>
<?php
$sql = "SELECT DISTINCT a.sgid,b.subject_id,a.last_name,a.first_name,d.section FROM stud_grade_tbl AS a INNER JOIN grade_tbl AS b LEFT JOIN faculty_tbl AS c ON c.subject_id=b.subject_id LEFT JOIN section_tbl AS d ON d.section_id=a.section_id WHERE b.grade_id=a.grade_id && c.user_email='".$_SESSION["user_email"]."' && a.section_id = '004'";
$result = $conn->query($sql);
