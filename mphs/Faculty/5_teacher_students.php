...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<a href="pdf list/view_list3.php">
       ...
       <?php
        ...
        $stmt = $db_con->prepare("SELECT DISTINCT a.sgid,a.section_id,a.last_name,a.first_name FROM stud_grade_tbl AS a INNER JOIN grade_tbl AS b LEFT JOIN faculty_tbl AS c ON c.section_id=b.section_id WHERE b.grade_id=a.grade_id && a.section_id = '007'");
        $stmt->execute();
