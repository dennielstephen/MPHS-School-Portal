    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active selected a">
						...
						<ul class="nav nav-second-level">
                            ...
                            <li class="active selected a" >
                                <a href="#"><i class="fa fa-circle fa-fw"></i>Elementary<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <!--<li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Grade 4</h1>
                </div>
                 <!-- end  page header -->
            </div>
        ...
        $stmt = $db_con->prepare("SELECT DISTINCT b.gid,b.subject_id,d.subject,a.last_name,a.first_name,b.1stQA,b.2ndQA,b.3rdQA,b.4thQA FROM stud_grade_tbl AS a INNER JOIN grade_tbl AS b LEFT JOIN faculty_tbl AS c ON c.subject_id=b.subject_id LEFT JOIN subject_tbl AS d ON d.subject_id=b.subject_id && b.subject_id = d.subject_id WHERE b.grade_id=a.grade_id && a.section_id = '006' ORDER BY b.gid");
        $stmt->execute();
