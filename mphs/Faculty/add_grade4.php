...
?>
<?php
require_once('cs/class_students4.php');
$user = new USER();
		...
		try
		{
			...
			if($row['stud_id']==$sid) {
				...
				if($user->register($sid,$gid,$LN,$FN,$Sect,$UMail,$UPass)){	
					$user->redirect('add_grade4.php?joined');
				}
			}
		}
		...
		<?php
			...
			else if(isset($_GET['joined']))
			{
                 ...
                 <div class="alert alert-info">
                      <i class="glyphicon glyphicon-log-in"></i> &nbsp; Successfully added data <a href='4_teacher_students.php'>go back</a> here
                 </div>
                 <?php
			}
			?>
