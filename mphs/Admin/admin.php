...
<body>
    ...
    <div id="wrapper">
        ...
        <th>Time of Last Logout</th>
        </tr>
        </thead>
        <tbody>
		<?php
		$sql = "SELECT * FROM stud_grade_tbl";
		...
		?>
			...
			<td><?php echo $row['id3']."-".$row['section_id']; ?></td>
            <td><?php echo $row['date']; ?></td>
            <td><?php echo $row['time']." ".$row['hr']; ?></td>
			<td><?php echo $row['date2']; ?></td>
            <td><?php echo $row['time2']." ".$row['hr2']; ?></td>
            </tr>
		<?php
			}
		}
