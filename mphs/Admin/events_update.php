...
<head>
	...
	<script type="text/javascript" src="crud_events.js"></script>
</head>
<body>
    <!--  wrapper -->
    <div id="wrapper">
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">	
			<a id="<?php echo $row['ann_id']; ?>" class="edit-link" href="#" title="Edit">
			<i class="fa fa-pencil"></i>
			</a></td>
			<!--<td align="center">
			<a id="<?php echo $row['ann_id']; ?>" class="delete-link" href="#" title="Delete">
