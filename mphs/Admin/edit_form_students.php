...
#dis{
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            <td>Grade ID</td>
            <td><input type='text' name='grade_id' class='form-control' value='<?php echo $row['grade_id']; ?>' required></td>
        </tr>
        ...
        <tr>
            <td>Password</td>
            <td><input type='text' name='user_pass' class='form-control' value='<?php echo $row['user_pass']; ?>' required></td>
        </tr>
