...
<head>
	...
	<script type="text/javascript" src="crud_home.js"></script>
    <script type="text/javascript">
    function myFunction() {
        var r = confirm ("Are you sure?");
        if(r == true){
            document.getElementById("form").action = "index_upload.php";
        }
    }
    </script>
</head>
<body>
    ...
    <div id="wrapper">
        ...
        $stmt = $db_con->prepare("SELECT * FROM index_tbl ORDER BY iid DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td><?php echo $row['index_pic']; ?></td>
			<td><?php echo $row['pic_desc']; ?></td>
			<td><?php echo $row['desc_pic']; ?></td>
			<td><?php echo $row['text']; ?></td>
			<td align="center">	
			<a id="<?php echo $row['iid']; ?>" class="edit-link" href="#" title="Edit">
