...
<head>
	...
	<script type="text/javascript" src="crud_gallery.js"></script>
</head>
<body>
    <!--  wrapper -->
    <div id="wrapper">
        ...
        $stmt = $db_con->prepare("SELECT * FROM gallery_tbl ORDER BY galid DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td><?php echo $row['gallery_pic']; ?></td>
			<td><?php echo $row['gallery_desc']; ?></td>
			<td align="center">	
			<a id="<?php echo $row['galid']; ?>" class="edit-link" href="#" title="Edit">
			<i class="fa fa-pencil"></i>
			</a></td>
			<!--<td align="center">
			<a id="<?php echo $row['galid']; ?>" class="delete-link" href="#" title="Delete">
