...
<head>
	...
	<script type="text/javascript" src="crud_subjects.js"></script>
</head>
<body>
    <!--  wrapper -->
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <form action="import_files/import_subjects.php" method="post" name="upload_excel" enctype="multipart/form-data">
        ...
        $stmt = $db_con->prepare("SELECT * FROM subject_tbl ORDER BY subid");
        $stmt->execute();
        while($row=$stmt->fetch(PDO::FETCH_ASSOC))
        {
            ...
            <td align="center"> 
            <a id="<?php echo $row['subid']; ?>" class="edit-link" href="#" title="Edit">
            <i class="fa fa-pencil"></i>
            </a></td>
            <td align="center">
            <a id="<?php echo $row['subid']; ?>" class="delete-link" href="#" title="Delete">
