...
<body>
    ...
    <div id="wrapper">
        ...
        $stmt = $db_con->prepare("SELECT DISTINCT b.gid,b.subject_id,a.last_name,a.first_name,d.subject,b.1stQA,b.2ndQA,b.3rdQA,b.4thQA FROM stud_grade_tbl AS a INNER JOIN grade_tbl AS b LEFT JOIN faculty_tbl AS c ON c.subject_id=b.subject_id LEFT JOIN subject_tbl AS d ON d.subject_id=b.subject_id WHERE b.grade_id=a.grade_id && a.section_id = '10'");
        $stmt->execute();
