...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <form action="import_files/import_faculty.php" method="post" name="upload_excel" enctype="multipart/form-data">
            ...
            <!--<a href="add_faculty.php">
				<button class="btn btn-info" type="button" id="btn-add"> <span class="fa fa-plus-circle"></span> &nbsp; Add Teacher</button>
			</a>
            <button class="btn btn-danger" type="button" id="btn-delselc" disabled="disabled"> <span class="fa fa-trash-o"></span> &nbsp; Delete</button>-->
            <div class="row">
                <div class="col-lg-12">
                    <!-- Advanced Tables -->
        ...
        $stmt = $db_con->prepare("SELECT * FROM faculty_tbl ORDER BY teacher_id");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
            ...
            <td><?php echo $row['id5']."-".$row['teacher_id']; ?></td>
			<td><?php echo $row['first_name']." ".$row['last_name']; ?></td>
			<td><?php echo $row['id4']."-".$row['subject_id']; ?></td>
            <td><?php echo $row['user_email']; ?></td>
            <td><?php echo $row['dec_pass']; ?></td>
			<td align="center">	
			<a id="<?php echo $row['fid']; ?>" class="edit-link" href="#" title="Edit">
			<i class="fa fa-pencil"></i>
			</a></td>
			<td align="center"><a id="<?php echo $row['fid']; ?>" class="delete-link" href="#" title="Delete">
