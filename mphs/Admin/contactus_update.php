...
<head>
	...
	<script type="text/javascript" src="crud_contus.js"></script>
</head>
<body>
    <!--  wrapper -->
    <div id="wrapper">
        ...
        $stmt = $db_con->prepare("SELECT * FROM contactus");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">	
			<a id="<?php echo $row['cont_id']; ?>" class="edit-link" href="#" title="Edit">
			<i class="fa fa-pencil"></i>
			</a></td>
			<!--<td align="center">
			<a id="<?php echo $row['cont_id']; ?>" class="delete-link" href="#" title="Delete">
