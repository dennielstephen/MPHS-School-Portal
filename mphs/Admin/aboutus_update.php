...
<head>
	...
	<script type="text/javascript" src="crud_aboutus.js"></script>
</head>
<body>
    <!--  wrapper -->
    <div id="wrapper">
        ...
        $stmt = $db_con->prepare("SELECT * FROM aboutus ORDER BY about_id DESC");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<td align="center">	
			<a id="<?php echo $row['about_id']; ?>" class="edit-link" href="#" title="Edit">
			<i class="fa fa-pencil"></i>
			</a></td>
			<!--<td align="center">
			<a id="<?php echo $row['about_id']; ?>" class="delete-link" href="#" title="Delete">
