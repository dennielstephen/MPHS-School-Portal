...
<head>
	...
	<script type="text/javascript" src="crud_achievers.js"></script>
</head>
<body>
    <!--  wrapper -->
    <div id="wrapper">
        ...
        <tr>
		<th>ID</th>
        <th>Achiever Picture</th>
        <th>Achiever Description</th>
        <th>Edit</th>
        </tr>
        </thead>
        <tbody>
        ...
        $stmt = $db_con->prepare("SELECT * FROM achievers ORDER BY ach_id");
        $stmt->execute();
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			?>
			<tr>
			<td><?php echo $row['ach_id']; ?></td>
			<td><?php echo $row['ach_pic']; ?></td>
			<td><?php echo $row['pic_desc']; ?></td>
			<td align="center">	
			<a id="<?php echo $row['ach_id']; ?>" class="edit-link" href="#" title="Edit">
			<i class="fa fa-pencil"></i>
			</a></td>
			<!--<td align="center">
			<a id="<?php echo $row['ach_id']; ?>" class="delete-link" href="#" title="Delete">
